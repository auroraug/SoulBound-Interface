...
<div id="network" class="net">网络</div>
<div class="main">
...
<div class="admin">
<form method="post" id="form1" style="background: #c5e4f8" action="<%=path%>/_adminservlet">
    <input type="hidden" id="address" name="address" value="">
    <input type="hidden" id="networkname" name="networkname" value="">
    <input type="button" id="gly" onclick="admin()" value="管理员登录前请先连接钱包">
    <br>${error}
</form>
</div>
<div class="verifier">
    <form method="post" id="form2" style="background: #c5e4f8" action="<%=path%>/_verifierservlet">
        <input type="hidden" id="address1" name="address1" value="">
        <input type="hidden" id="networkname1" name="networkname1" value="">
        <input type="button" id="yzz" onclick="verifier()" value="验证者登录前请先连接钱包">
        <br>${error1}
    </form>
</div>
<div class="scholar">
    <form method="post" id="form3" style="background: #c5e4f8" action="<%=path%>/_scholarservlet">
        <input type="hidden" id="address2" name="address2" value="${acc}">
        <input type="hidden" id="networkname2" name="networkname2" value="">
        <input type="button" id="xz" onclick="scholar()" value="学者登录前请先连接钱包">
        <br>${error2}
    </form>
</div>
<%--<div>
