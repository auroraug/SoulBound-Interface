...
<div class="login_box">
<form method="post" id="form1" action="<%=path%>/_adminservlet">
    ...
    <form method="post"  id="form2"  action="<%=path%>/_verifierservlet">
    ...
    <form method="post"  id="form3"  action="<%=path%>/_scholarservlet">
